...
public class Pose extends SubsystemBase {
    ...
    public Pose() {
        ...
        poseEstimator =
                new SwerveDrivePoseEstimator(
                        Robot.swerve.getSwerveDriveKinematics(),
                        Robot.swerve.getRotation(),
                        Robot.swerve.getSwerveModulePositions(),
                        new Pose2d(),
                        createStateStdDevs(
    ...
    public void updateOdometryEstimate() {
        poseEstimator.update(Robot.swerve.getRotation(), Robot.swerve.getSwerveModulePositions());
    }
    ...
    public void resetPoseEstimate(Pose2d poseMeters) {
        Robot.swerve.resetPose(poseMeters);
        poseEstimator.resetPosition(
                Robot.swerve.getRotation(), Robot.swerve.getSwerveModulePositions(), poseMeters);
    }
